...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TypeScript processing");
    
    let mut processor = TypeScriptProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TypeScriptProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TypeScriptProcessor::new(false);
